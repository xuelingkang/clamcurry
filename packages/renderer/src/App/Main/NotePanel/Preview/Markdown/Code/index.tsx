...
type IProps = React.ClassAttributes<HTMLElement> &
    ...
    ExtraProps & { multipleLine?: boolean };

const Code: FC<IProps> = (props: IProps) => {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const { children, className, multipleLine, node, ...otherProps } = props;
    ...
    return (
        <>
            <If condition={multipleLine === true}>
            ...
            <If condition={!multipleLine}>
                <code {...otherProps} className={clsx('inline-code', className)}>
                    {children}
                </code>
            </If>
        </>
